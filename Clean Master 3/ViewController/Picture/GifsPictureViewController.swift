//
//  GifsPictureViewController.swift
//  Clean Master 3
//
...
class GifsPictureViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        GifsCollectionView.register(UINib(nibName: "AllPictureCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "AllPictureCollectionViewCell")
    ...
    func getDataImage(){
        PhotoLibraryManager.shared.authorize(fromViewController: self) {[weak self] (authorized) -> Void in
            ...
            self?.assets.append(contentsOf: PhotoLibraryManager.shared.getgifImageAsset())
...
extension GifsPictureViewController: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension GifsPictureViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if UIDevice.current.userInterfaceIdiom == .pad{
            return CGSize(width: self.GifsCollectionView.frame.width * 1/6 - 10 , height: self.GifsCollectionView.frame.width * 1/6)
        }
        return CGSize(width: self.GifsCollectionView.frame.width * 1/3 - 7 , height: self.GifsCollectionView.frame.width * 1/3)
